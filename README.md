...
- **Canvas** — an infinite drawing surface for sketches and diagrams, saved locally. Fully branded as Canvas in-app (the underlying open-source drawing engine's logo and upsell branding are stripped on load).
